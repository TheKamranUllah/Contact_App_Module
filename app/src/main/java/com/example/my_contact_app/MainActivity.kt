...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val addNewContactFAB = findViewById<FloatingActionButton>(R.id.idFABadd)
...
// on below line we are getting the phone number.// if the count is greater than 0 then we are running a loop to move our cursor to next.
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (hasPhoneNumber > 0) {
                        ...
                        if (phoneCursor!!.moveToNext()) {
                            ...
                            contactsModalArrayList!!.add(ContactsModal(displayName, phoneNumber, contactId))
                        }
                        // on below line we are closing our phone cursor.
                        phoneCursor.close()
                    }
